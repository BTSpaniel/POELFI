...
set OFTRTA="http://www.thiessen.im/PoE/oftrta_v3.4.3.filter"
set OFTRTAMAP="http://www.thiessen.im/PoE/oftrta_v3.4.3_map.filter"
set OFTRTARICH="http://www.thiessen.im/PoE/oftrta_v3.4.3_rich.filter"
